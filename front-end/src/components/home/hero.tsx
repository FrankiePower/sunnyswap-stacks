        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <Badge className="inline-flex items-center gap-2 px-4 py-2 text-sm bg-orange-500/10 border border-orange-500/30 text-orange-400 hover:bg-orange-500/20">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Swap <strong>trustlessly</strong> <span>between</span> <br />
                <strong>EVM</strong> <span>&</span> <strong className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Stacks</strong>
              </h1>
            </motion.div>
            ...
            >
              Execute secure, trustless atomic swaps between EVM chains and Stacks blockchain. No intermediaries, no custody risk—just pure decentralized cross-chain trading.
            </motion.p>
              ...
              <div className="flex items-center justify-center">
                <a href="/dapp">
                  <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                    <div className="border border-orange-500 bg-orange-500 h-[40px] rounded-full flex items-center justify-center text-white">
