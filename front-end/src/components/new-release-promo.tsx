...
export function NewReleasePromo() {
  return (
    <section className="mt-12 mb-24 w-full px-4">
      <div className="mx-auto max-w-4xl rounded-[40px] border border-orange-500/20 p-2 shadow-2xl">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-orange-500/30 bg-gradient-to-br from-orange-500/20 via-orange-600/10 to-black p-2 shadow-sm">
          {/* Subtle radial glow from center */}
          <div
            className="absolute inset-0 z-0"
            style={{
              background: "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(249, 115, 22, 0.2), transparent 70%)",
            }}
          />
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Ready to Swap?</h2>
              <p className="text-white/70 mb-8 max-w-2xl mx-auto">
                Join the future of cross-chain trading. Secure, trustless, and completely decentralized.
              </p>
              <svg
                width="100"
                height="50"
                ...
                className="fill-white mx-auto mb-4 opacity-80"
              >
              ...
              <div className="flex items-center justify-center">
                <a href="/app">
                  <div className="group bg-orange-500/10 border border-orange-500/30 flex h-[64px] cursor-pointer items-center gap-2 rounded-full p-[11px] mt-10 hover:bg-orange-500/20 transition-all">
                    <div className="bg-orange-500 flex h-[43px] items-center justify-center rounded-full border border-orange-600">
                    ...
                    <div className="border-orange-500/50 text-orange-400 flex size-[26px] items-center justify-center rounded-full border-2 transition-all ease-in-out group-hover:ml-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                        height="18"
            ...
            <h1
              className="absolute inset-x-0 mt-[120px] text-center text-[100px] font-semibold bg-gradient-to-b from-orange-500/40 to-orange-600/20 bg-clip-text text-transparent sm:mt-[30px] sm:text-[190px] pointer-events-none select-none"
              aria-hidden="true"
            >
              SUNNYSWAP
            </h1>
